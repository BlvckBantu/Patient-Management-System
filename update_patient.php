...
if (isset($_POST['save_Patient'])) {
    ...
    $nationaID = trim($_POST['national_id_no']);
...
`national_id_no`, date_format(`date_of_birth`, '%m/%d/%Y') as `date_of_birth`,  `phone_number`, `gender` 
...
<head>
 ...
 <?php include './config/data_tables_css.php';?>
  ...
  <title>Nairobi Hospice - Update Patient Details</title>
          ...
          <form method="post">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                ...
                class="form-control form-control-sm rounded-0" value="<?php echo $row['national_id_no'];?>" />
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
