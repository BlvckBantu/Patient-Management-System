...
<head>
  ...
  <title>Nairobi Hospice - Login</title>
...
<body class="hold-transition login-page dark-mode">
  <div class="login-box">
    <div class="login-logo mb-4">
      ...
      <div class="text-center h2 mb-0">Nairobi Hospice Patient Management system</div>
    </div>
    ...
    <div class="card card-outline card-primary rounded-0 shadow">
      <div class="card-body login-card-body">
        ...
        <form method="post">
          ...
          <div class="row">
            <div class="col-12">
              <button name="login" type="submit" class="btn btn-primary rounded-0 btn-block">Login</button>
            </div>
            <!-- /.col -->
          </div>
