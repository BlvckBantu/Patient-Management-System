...
if (isset($_POST['save_Patient'])) {
    ...
    $nationalID = trim($_POST['national_id_no']);
...
if ($patientName != '' && $address != '' && 
  $nationalID != '' && $dateBirth != '' && $phoneNumber != '' && $gender != '') {
      $query = "INSERT INTO `patients`(`patient_name`, 
    `address`, `national_id_no`, `date_of_birth`, `phone_number`, `gender`)
VALUES('$patientName', '$address', '$nationalID', '$dateBirth',
'$phoneNumber', '$gender');";
try {
...
`national_id_no`, date_format(`date_of_birth`, '%d %b %Y') as `date_of_birth`, 
`phone_number`, `gender` 
...
<head>
 ...
 <?php include './config/data_tables_css.php';?>
  ...
  <title>Nairobi Hospice - Patient Management System</title>
          ...
          <form method="post">
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                ...
                <input type="text" id="national_id_no" name="national_id_no" required="required"
                class="form-control form-control-sm rounded-0"/>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
